  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Zoro, your gateway to creating a unique web app for your Anime platform. Unleash your creativity, the possibilities are endless."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1519638399535-1b036603ac77?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhbmltZXxlbnwwfHx8fDE2ODk5MTU5NjV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Zoro, your gateway to creating a unique web app for your Anime platform. Unleash your creativity, the possibilities are endless.`}
            </Text>
            <Box
