...
import { getAnimeContents } from 'apiSdk/anime-contents';
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <AsyncSelect<AnimeContentInterface>
            formik={formik}
            name={'content_id'}
            label={'Select Anime Content'}
            placeholder={'Select Anime Content'}
            fetcher={getAnimeContents}
            labelField={'title'}
          />
          ...
          <Flex justifyContent={'flex-start'}>
            ...
            <Button
              ...
              gap="0.5rem"
              mr="4"
              onClick={() => router.push('/user-interactions')}
              _hover={{
                bg: 'neutral.transparent',
                color: 'neutral.main',
              }}
