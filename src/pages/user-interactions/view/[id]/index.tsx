...
import { getUserInteractionById } from 'apiSdk/user-interactions';
import { UserInteractionInterface } from 'interfaces/user-interaction';

function UserInteractionViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'User Interaction Details',
              isCurrent: true,
            },
          ]}
        />
              ...
              >
                ...
                {hasAccess('anime_content', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Anime Content"
                    text={
                      <Link as={NextLink} href={`/anime-contents/view/${data?.anime_content?.id}`}>
                        {data?.anime_content?.title}
                      </Link>
                    }
                  />
                )}
