...
import { getAnimeContentById } from 'apiSdk/anime-contents';
import { AnimeContentInterface } from 'interfaces/anime-content';
import { UserInteractionListPage } from 'pages/user-interactions';

function AnimeContentViewPage() {
